...
public class SwaggerConfiguration {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("io.github.mhsscel.bookjavaapi.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Book Java API")
				.description("Book Java API - Endpoint's documentation").version(releaseVersion.concat("_").concat(apiVersion))
				.build();
	}
