package io.github.mhsscel.bookjavaapi.util.interceptor;
...
public class RateLimitInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
    	...
    	String apiKey = request.getHeader(BookApiUtil.HEADER_API_KEY);
    	
        if (apiKey == null || apiKey.isEmpty()) {
            response.sendError(HttpStatus.BAD_REQUEST.value(), "Missing Header: " + BookApiUtil.HEADER_API_KEY);

            log.error("Missing Header: " + BookApiUtil.HEADER_API_KEY);
            return false;
        }
        ...
        if (probe.isConsumed()) {
            ...
            response.addHeader(BookApiUtil.HEADER_LIMIT_REMAINING, String.valueOf(probe.getRemainingTokens()));
            return true;
            ...
            response.addHeader(BookApiUtil.HEADER_RETRY_AFTER, String.valueOf(waitForRefill));
